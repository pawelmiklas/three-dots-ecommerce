  ...
  return (
    <div className={classes.outline}>
      ...
      <Row className={classes.container}>
        {promotedProduct && (
          <>
            <Col offset={1} span={14} className={classes.image}>
              <Image src={promotedProduct.image} height={596} width={900} quality={100} />
            </Col>
            <Col span={8}>
              ...
              <Row justify="space-between">
                <Col>
                  <Title level={5}>
                    {promotedProduct.price} {currency.toUpperCase()}
                  </Title>
                </Col>
                <Col>
                  <Button size="large" type="primary" className={classes.button} icon={<ShoppingOutlined />} />
                </Col>
              </Row>
            </Col>
          </>
