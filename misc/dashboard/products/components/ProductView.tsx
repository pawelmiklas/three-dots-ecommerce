...
const ProductView = ({ isModalVisible, product, onCancel }: ProductViewProps) => {
  return (
    <Modal visible={isModalVisible} width={800} footer={null} onCancel={onCancel} title="Product Info">
      <Descriptions bordered>
        <Descriptions.Item label="Name" span={3}>
          {product.name}
        </Descriptions.Item>
        <Descriptions.Item label="Price">
          <NumberFormat value={product.price} displayType="text" thousandSeparator prefix="$" />
        </Descriptions.Item>
